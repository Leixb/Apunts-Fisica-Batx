...
\begin{align*}
    ...
    \omega &= \text{velocitat angular} &= \frac{d\phi}{dt} = \frac{\Delta \phi}{\Delta t} = \omega_0 + \alpha t \\
    \alpha &= \text{acceleració angular} &= \frac{d\omega}{dt} = \frac{\Delta \omega}{\Delta t} \\
    \nu &= \text{freqüència} \\
