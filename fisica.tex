...
Moviment generat per una força harmònica. Una força harmònica és proporcional
a la distància a un punt d'equilibri:
...
On $\omega$ és la freqüència, $A$ l'amplitud i $\phi$ la fase.
...
\subsection{Període d'un pèndul}
\label{sub:periode_d_un_pendul}
...
\begin{enumerate}
    ...
    \item Moviment harmònic simple i Ones
